...
class ArticleDAO extends DAO
{
    ...
    {
        $sql = 'SELECT article.id, article.title, article.content, user.pseudo, article.created_at FROM article INNER JOIN user ON article.user_id = user.id WHERE article.id = ?';
